...
if not my_api_key:
    raise ValueError("Inavalid API Key")
...
text="i am parag my phone is not working i love bhindi i am livin in banglore my email is abc@gmail.com"
prompt = f"""
...
#How next code will read this output
